        ...
        <CardContent>
          ...
          {tableMode === 'FCL' && (
            <Paper variant="outlined" sx={{ overflowX: 'auto' }}>
              <RateTable mode="FCL" rows={tableRows.FCL} bookingCounts={tableRows.bookingCounts} hideCost={hideCost} hideRos={hideRos} hideSell={hideSell} onEdit={()=> navigate(`/rates?q=${encodeURIComponent(laneStr)}&mode=FCL&auto=1`)} />
            </Paper>
          )}
          {tableMode === 'LCL' && (
            <Paper variant="outlined" sx={{ overflowX: 'auto' }}>
              <RateTable mode="LCL" rows={tableRows.LCL} bookingCounts={tableRows.bookingCounts} hideCost={hideCost} hideRos={hideRos} hideSell={hideSell} onEdit={()=> navigate(`/rates?q=${encodeURIComponent(laneStr)}&mode=LCL&auto=1`)} />
            </Paper>
          )}
          {tableMode === 'Air' && (
            <Paper variant="outlined" sx={{ overflowX: 'auto' }}>
              ...
              {(() => {
                ...
                if (sheets.length) {
                  ...
                  return <RateTable mode="Air" rows={combined} bookingCounts={tableRows.bookingCounts} hideCost={hideCost} hideRos={hideRos} hideSell={hideSell} onEdit={()=> navigate(`/rates?q=${encodeURIComponent(laneStr)}&mode=Air&auto=1`)} />;
                }
                return <RateTable mode="Air" rows={derived} bookingCounts={tableRows.bookingCounts} hideCost={hideCost} hideRos={hideRos} hideSell={hideSell} onEdit={()=> navigate(`/rates?q=${encodeURIComponent(laneStr)}&mode=Air&auto=1`)} />;
              })()}
            </Paper>
          )}
        </CardContent>
